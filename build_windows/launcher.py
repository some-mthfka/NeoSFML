...
Warning: the following code is adapted for Windows for now and requires
a program called pipelist to functions correctly.
TODO: For linux, refer to cli.py of the Neovim Python client.
"""
